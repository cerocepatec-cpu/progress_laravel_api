...
class AccountingService
{
    ...
    public function summary(Member $actor): array
    {
    ...
    public function transfer(Member $actor, array $payload): array
    {
    ...
    public function storeEntry(Member $actor, array $payload): int
    {
        $amount = (float) $payload['amount'];
    ...
    public function storeWayout(Member $actor, array $payload): int
    {
        $amount = (float) $payload['amount'];
    ...
    public function memberLedger(Member $member): array
    {
        return [
    ...
    public function reports(Member $actor, array $filters): array
    {
    ...
    public function cashOperations(Member $actor): Collection
    {
    ...
    public function cashOperation(Member $actor, int $cashId): object
    {
    ...
    public function storeCashOperation(Member $actor, array $payload): int
    {
    ...
    public function vipPackets(Member $actor): array
    {
        return [
            'balance' => (float) $actor->total_amount_e_wallet,
    ...
    public function buyVipPackets(Member $actor, array $payload): array
    {
    ...
    private function queryEntries(Member $actor, string $from, string $to, Collection $accounts, bool $canManageAll)
    {
    ...
    private function queryWayouts(Member $actor, string $from, string $to, Collection $accounts, bool $canManageAll)
    {
    ...
    private function canManageAll(Member $actor): bool
    {
        return (int) $actor->member_code === 1 || in_array((int) $actor->categorie_id, [6, 9], true);
    }

    private function resolveMember(string|int $identifier): Member
    {
        $member = Member::query()
    ...
    private function lockMember(int|string $identifier): Member
    {
        $member = Member::query()
            ->where('member_code', $identifier)
            ->orWhere('member_id', (string) $identifier)
