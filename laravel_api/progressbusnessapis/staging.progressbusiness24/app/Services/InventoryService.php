...
{
    public function deposits(Member $actor)
    {
    ...
    public function storeDeposit(array $payload, Member $actor): int
    {
        if (! empty($payload['id'])) {
            DB::table('deposits')
    ...
    public function attachUser(int $depositId, string|int $memberIdentifier, string $access, Member $actor): void
    {
    ...
    public function movements(Member $actor)
    {
    ...
    public function stockValues(Member $actor)
    {
        return DB::table('depositproducts as dp')
    ...
    public function storeMovement(array $payload, Member $actor): int
    {
        $type = $payload['type'];
    ...
    public function transfers(Member $actor)
    {
    ...
    public function storeTransfer(array $payload, Member $actor): int
    {
    ...
    public function validateTransfer(int $transferId, float $quantityReceived, Member $actor): void
    {
    ...
    public function denyTransfer(int $transferId, Member $actor): void
    {
